    ...
    "node_modules/scheduler/cjs/scheduler.development.js"(exports) {
      ...
      if (true) {
        (function() {
          ...
          function siftDown(heap2, node, i) {
            var index = i;
...
${val.stack}`;
  ...
  var CounterApp = class {
    static __wrap(ptr) {
      const obj = Object.create(CounterApp.prototype);
      obj.ptr = ptr;
      return obj;
    }
    __destroy_into_raw() {
    ...
    free() {
      ...
      wasm.__wbg_counterapp_free(ptr);
    }
    static new(client) {
      _assertClass(client, WebClient);
      var ptr0 = client.ptr;
      client.ptr = 0;
      var ret = wasm.counterapp_new(ptr0);
      return CounterApp.__wrap(ret);
    }
    increment() {
      wasm.counterapp_increment(this.ptr);
    }
    decrement() {
      wasm.counterapp_decrement(this.ptr);
    }
  };
  var WebClient = class {
    static __wrap(ptr) {
    ...
    static new(options) {
      var ret = wasm.webclient_new(addHeapObject(options));
  ...
  async function init(input) {
    if (typeof input === "undefined") {
      input = new URL("suit_web_bg.wasm", import_meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_log_dd5f4f05adcbaada = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_get_75d36ef8b2e1d918 = function() {
      return handleError(function(arg0, arg1) {
        var ret = Reflect.get(getObject(arg0), getObject(arg1));
        return addHeapObject(ret);
      }, arguments);
    };
    imports.wbg.__wbg_call_9698e9b9c4668ae0 = function() {
      return handleError(function(arg0, arg1) {
        var ret = getObject(arg0).call(getObject(arg1));
        return addHeapObject(ret);
      }, arguments);
    };
    imports.wbg.__wbg_call_4438b4bab9ab5268 = function() {
  ...
  var suit_web_default = init;

  // src/app.jsx
  var App = ({ CounterApp: CounterApp2 }) => {
    const [app, setApp] = (0, import_react.useState)();
    const [counterState, setCounterState] = (0, import_react.useState)();
    (0, import_react.useEffect)(() => {
      const app2 = CounterApp2.new(WebClient.new({
    ...
    return /* @__PURE__ */ import_react.default.createElement(Counter, {
      state: counterState,
      handleDecrement: () => app.decrement(),
      handleIncrement: () => app.increment()
    });
  };
  var Counter = ({ state, handleIncrement, handleDecrement }) => {
    const styles = {
      textAlign: "center",
      fontSize: "200%",
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", {
      style: styles
    }, /* @__PURE__ */ import_react.default.createElement("p", null, "counter is: ", state), /* @__PURE__ */ import_react.default.createElement("button", {
      onClick: handleIncrement
    }, "+"), /* @__PURE__ */ import_react.default.createElement("button", {
      onClick: handleDecrement
    }, "-"));
  };
  suit_web_default("suit-web/pkg/suit_web_bg.wasm").then(() => {
    ReactDOM.render(/* @__PURE__ */ import_react.default.createElement(App, {
      CounterApp
